  ...
  return (
    <>
      {tags.map((tag) => {
        return (
          <span
            className={`flex justify-center items-center z-1 text-center text-[14px] pb-[1px] text-white w-[40px] px-[6px] pt-[0] rounded-[4px] font-medium ${
